...
<div class="mb-3">
  ...
  <input type="mobile" value="<c:out value="${customer.mobile}"></c:out>" class="form-control" id="exampleFormControlInput3" name="tbmobil" placeholder="Enter your mobile number" required="required">
</div>
